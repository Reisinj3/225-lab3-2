pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/reisinj3'                                                 // <------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/Reisinj3/225-lab3-2.git'                   // <------change this
        KUBECONFIG = credentials('reisinj3-225')                                             // <------change this
    }
